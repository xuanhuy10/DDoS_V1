...
import { Card, Collapse, Divider, Flex, Space, Table, Tag } from "antd";
...
const InterfaceStatus = () => {
    ...
    const liveData = useMemo(() => {
        ...
        for (let i = 1; i <= 8; i++) {  // eth1 to eth8
            const port = `eth${i}`;
                ...
                >
                                ...
                                >
                                    ...
                                    <span 
                                        style={{ 
                                            fontSize: '10px', 
                                            fontWeight: 'bold',
                                            color: isUnderAttack ? '#D12200' : (isActive ? '#0073D1' : '#888'),
                                            marginTop: '2px'
                                        }}
                                    >
                                        {portNumber}
                    ...
                    <Flex gap="20px" align="center">
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <span style={{ fontSize: '14px', fontWeight: 'bold', color: '#0073D1', marginTop: '2px' }}>
                                SFP1
                            </span>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    ...
    return (
        <div
            onMouseEnter={function () { setActiveKey('interface'); }}
            onMouseLeave={function () { setActiveKey(null); }}
        >
