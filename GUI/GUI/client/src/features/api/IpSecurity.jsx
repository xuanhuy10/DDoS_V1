...
export const updateIpSecProfile = async (profileId, profileData) => {
  try {
    const mappedData = {
      ...
      ProfileDescription: profileData.IpSecProfileDescription || profileData.ProfileDescription,
      ...
      ConnectionCount: profileData.ConnectionCount || 1,  // Thêm để đồng bộ
      IKEVersion: profileData.IKE2Version || profileData.IKEVersion,
      Mode: profileData.IKEMode || profileData.Mode,
      ESPAHProtocol: profileData.ESPAHProtocol,
      IKEReauthTime: profileData.IKEReauthTime ? parseInt(profileData.IKEReauthTime, 10) : null,
      EncryptionAlgorithm: profileData.EncryptionAlgorithm,
      HashAlgorithm: profileData.HashAlgorithm,
      ReKeyTime: profileData.RekeyTime ? parseInt(profileData.RekeyTime, 10) : null,
