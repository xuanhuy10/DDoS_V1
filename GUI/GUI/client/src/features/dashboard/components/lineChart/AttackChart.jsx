...
const AttackChart = ({ attackData, time, col, paused }) => {
    ...
    const protocol_chart = () => {
        ...
        return {
            ...
            color: [theme.synFloodColor, theme.udpFloodColor, theme.icmpFloodColor, theme.dnsFloodColor, theme.httpFloodColor, theme.httpsFloodColor ,theme.ipsecColor, theme.tcpFragColor, theme.udpFragColor, theme.landColor, theme.normal],
            legend: {
            data: ['SYN Flood', 'UDP Flood', 'ICMP Flood', 'DNS Flood', 'HTTP Flood', 'HTTPs Flood', 'IPSec IKE Flood', 'TCP Fragment', 'UDP Fragment', 'LAND Attack', 'Normal'],
            type: 'scroll',
            },
            grid: {
            left: '3%',
